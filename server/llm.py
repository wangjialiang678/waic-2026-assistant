...
3. 每条信息标注来源，按以下优先级判断：
   ① source_type=official → 标「官方」（WAIC 官网论坛正式发布）；
   ② source_type=unofficial 但 waic_relation=official → 标「WAIC 官方合作」（官方合作项目，如超脑 AI 原住民计划，信息由合作方提供）——不要笼统称「非官方」；
   ③ 其余（source_type=unofficial 且非官方合作）→ 标「非官方」，并补一句「以官方为准」。
